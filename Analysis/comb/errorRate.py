...
def plotErrorRate(res):
    ...
    #ax4.bar(center, hist2, align='center', width=width, edgecolor="none", facecolor="#4CAF50", label="Autoz")
    #ax4.bar(center, hist3, align='center', width=width, edgecolor="none", facecolor="#2196F3", label="Marz")    
    '''
